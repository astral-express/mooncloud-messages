...
(function (ChatController) {
    ...
    function checkIfChatExists(sender, receiver) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let chat = yield chat_schema_1.chatModel.find({
                    $or: [
                        {
                            $and: [
                                {
    ...
    function findAllChatsOfAUser(username) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let chats = yield chat_schema_1.chatModel.find({
    ...
    function initiateChat(sender, receiver, receivers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield chat_schema_1.chatModel.create({
    ...
    function sendMessage(sender, message, chatID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let chat = yield chat_schema_1.chatModel.findOne({
                    chatID: chatID,
                });
                if (chat) {
                    let date = Math.floor((new Date()).getTime() / 1000);
                    let id = (0, crypto_1.randomUUID)();
                    yield chat_schema_1.chatModel.updateOne({
                        _id: chat,
                    }, {
                        $push: {
                            messages: {
    ...
    function updateIfMessageIsSeen(chatID, messageID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield chat_schema_1.chatModel.updateMany({
