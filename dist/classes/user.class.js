...
class User {
    ...
    set setUserPassword(password) {
        var hash = bcrypt_util_1.Bcrypt.hashedPassword(password);
        this.password = hash;
    }
    get getUserPassword() {
    ...
    setLocalUser() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield local_users_controller_1.LocalUsersController.createLocalUser(this.userID, this.username, this.email, this.password, this.avatar, this.rank, this.status);
            }
            catch (err) {
    ...
    updateLocalUser(email, username, avatar) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield local_users_controller_1.LocalUsersController.updateLocalUser(email, username, avatar);
            }
            catch (err) {
                return console.error(err);
            }
    ...
    deleteLocalUser(userID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield local_users_controller_1.LocalUsersController.deleteLocalUser(userID);
            }
            catch (err) {
                return console.error(err);
            }
